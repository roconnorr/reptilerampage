...
namespace BeautifyEffect {
		...
		void UpdateKeywords ()
		{
			...
			keywords.ForEach((SCKeyword kw) => { if (kw.enabled) enabledKeywordCount++; });
		}
...
//																new string[] { Beautify.SKW_TINT, "Tint" },
																new string[] { Beautify.SKW_NIGHT_VISION, "Night Vision" },
																new string[] { Beautify.SKW_THERMAL_VISION, "Thermal Vision" },
																new string[] { Beautify.SKW_DEPTH_OF_FIELD, "Depth of Field (DoF)" },
																new string[] { Beautify.SKW_DEPTH_OF_FIELD_TRANSPARENT, "DoF Transp. Support" },
																...
																new string[] { Beautify.SKW_VIGNETTING_MASK, "Vignetting Mask" },
