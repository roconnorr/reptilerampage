...
public class GameMaster : MonoBehaviour {
	...
	public static void CreateBullet(Transform prefab, Vector3 position, float angle, int damage, float speed, float range, bool dmgPlayer, bool dmgEnemy) {
	...
	public static void CreateHomingBullet(Transform prefab, Vector3 position, float angle, int damage, float speed, float range, bool dmgPlayer, bool dmgEnemy, Transform target) {
		Transform bullet = Instantiate (prefab, position, Quaternion.Euler(0, 0, angle));
